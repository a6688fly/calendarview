...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
    ...
    /*今天的日期阳历文字颜色*/
    protected Paint mCurrentDayTextPaint = new Paint();

    /*今天的日期农历文字颜色*/
    protected Paint mCurrentDayLunarTextPaint = new Paint();
    ...
    private void initPaint(Context context) {
        ...
        mCurrentDayTextPaint.setTextSize(CalendarUtil.dipToPx(context, TEXT_SIZE));
   ...
   final void setup(CalendarViewDelegate delegate) {
    ...
    final void updateStyle(){
        ...
        this.mCurrentDayLunarTextPaint.setTextSize(mDelegate.getLunarTextSize());
        this.mCurrentDayTextPaint.setTextSize(mDelegate.getDayTextSize());
